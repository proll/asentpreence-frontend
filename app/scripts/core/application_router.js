aspe.Router = Backbone.Router.extend({
	_previous_route: '',
	previous_route: '',
	previous_page_route: '',
	...
	currentIsPopup: function() {
		return (this.route_passed>1) && this.isPopup(this.current_route);
	},
	isPopup: function(route) {
		return !Modernizr.touch && (_.indexOf(this.popoup_routes, route) !== -1)
	},
});